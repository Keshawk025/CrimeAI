...
alembic/env.py
───────────────
Alembic environment — wires our SQLAlchemy models and pydantic settings
into the migration engine.
...
# ── Path setup ─────────────────────────────────────────────────────────────────
# Ensure the backend root (parent of alembic/) is on sys.path so we can
...
# When you add new models, import them below:
...
# Override sqlalchemy.url with the real sync URL from pydantic settings
